...
def setup_model(width, height, channels):
    ...
    model.add(Convolution2D(128, 2, activation='relu',
                            padding='same',
    ...
    # hidden layer
    model.add(Convolution2D(32, 6, activation='relu', padding='same'))
    model.add(Dropout(0.1))
    ...
    # hidden layer
    model.add(Convolution2D(128, 2, activation='relu', padding='same'))
    model.add(Dropout(0.1))
