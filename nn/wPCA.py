...
print(x_test.shape)
[NA,num_features]=x_test.shape

from sklearn.decomposition import PCA
pca = PCA(num_features).fit(x_train)
components = pca.transform(x_train)
x_train = pca.inverse_transform(components)

pca = PCA(num_features).fit(x_test)
components = pca.transform(x_test)
x_test = pca.inverse_transform(components)
