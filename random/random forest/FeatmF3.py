...
def random_forest_classifier(features, label):
    clf = RandomForestClassifier(n_estimators=1000, max_depth=50, min_samples_leaf=2, max_features=0.3, n_jobs=-1,
                                random_state=0)
...
def main():
    ...
    print("Weights", trained_model.feature_importances_)
